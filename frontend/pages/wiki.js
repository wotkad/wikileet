...
export default async function WikiPage() {
    ...
    // Находим выбранного автора для отображения
    ...
    return `
        <div class="mx-auto">
            <div class="mb-6">
                ...
                ${renderFiltersInfo(selectedCategoryName, currentFilters.tagSlugs, tagMap, selectedAuthorName, currentFilters.dateFrom, currentFilters.dateTo)}
            ...
            ${(currentFilters.categorySlug || currentFilters.tagSlugs.length > 0 || currentFilters.dateFrom || currentFilters.dateTo || currentFilters.author) ? renderClearFilters() : ''}
